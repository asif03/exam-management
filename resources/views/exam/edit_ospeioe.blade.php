              ...
              <div class="row">
                ...
                <div class="col mx-3">
                  <input class="form-check-input" type="checkbox" name="is_schedule_meeting_chk"
                    id="is_schedule_meeting_chk" onclick="billingDeal()" @if($xmScMaster->is_schedule_meeting == 1)
                  checked
                  @endif" >
                ...
                <div class="col">
                  <div class="text-center p-2">
                    <button type="submit" class="btn btn-primary">Update <i class="fa fa-upload"
