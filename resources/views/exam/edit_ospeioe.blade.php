    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit OSPE IOE Scheduler </h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                <form id="ospe-ioe-form-edit" action="{{ route('update-schedule-master',$xmScMaster->id) }}" method="POST" data-toggle="validator"
                      role="form"
                    ...
                    <div class="p-2 border border-success border-2 rounded">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-floating mb-1">
                                    <select class="form-select" name="exam_type_id" id="exam_type_id" required
                                            onchange=""
                                            aria-label="Floating label select example">
                                        <option value="">Select</option>
                                        @foreach($examtype as $xmtype)
                                            <option value="{{ $xmtype->id }}"
                                                    @if ($xmScMaster->exam_type_id == $xmtype->id) selected
                                    ...
                                    <select class="form-select" name="mother_subject_id" id="mother_subject_id" required
                                        ...
                                        @foreach($subjects as $subject)
                                            <option value="{{ $subject->id }}"
                                                    @if ($xmScMaster->mother_subject_id == $subject->id) selected @endif >{{ $subject->subject_name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col">
                                <div class="form-floating mb-1">
                                    <select class="form-select" name="exam_year" id="exam_year" required onchange=""
                                            aria-label="Floating label select example">
                                        <option
                                            value="@php echo date('Y'); @endphp">@php echo date('Y'); @endphp</option>
                                        @foreach(range(date('Y')-1, date('Y') - 25) as $y)
                                            <option value="{{ $y }}" @if($xmScMaster->exam_year===$y) selected @endif>{{ $y}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col">
                                <div class="form-floating mb-1">
                                    <select class="form-select" name="exam_session" id="exam_session" required
                                            onchange=""
                                            aria-label="Floating label select example">
                                        <option  value="JAN" @if($xmScMaster->exam_session==="JAN") selected @endif>January</option>
                                        <option value="JUL" @if($xmScMaster->exam_session==="JUL") selected @endif>July</option>
                                    </select>
                        ...
                        <div class="col">
                            <div class="form-floating mb-1">
                                <input type="text" class="form-control" name="exam_date" id="exam_date" value="{{$xmScMaster->exam_date}}"
                            ...
                            <div class="col">
                                <div class="form-floating mb-1">
                                    <input type="text" class="form-control" name="reporting_time" id="reporting_time"
                                           value="{{$xmScMaster->reporting_time}}" required
                                           maxlength="15">
                            ...
                            <div class="col">
                                <div class="form-floating mb-1">
                                    <input type="text" class="form-control" name="exam_start_time" id="exam_start_time"
                                           value="{{$xmScMaster->exam_start_time}}" required
                                           maxlength="15">
                            ...
                            <div class="col">
                                <div class="form-floating mb-1">
                                    <input type="text" class="form-control" name="exam_end_time" id="exam_end_time"
                                           value="{{$xmScMaster->exam_end_time}}" required
                                           maxlength="15">
                                ...
                                <div class="form-floating mb-1">
                                    <select class="form-select" name="hall_id" id="hall_id" required onchange=""
                                        ...
                                        @foreach($examhall as $xmhall)
                                            <option value="{{ $xmhall->id }}"  @if($xmScMaster->hall_id == $xmhall->id) selected @endif>{{ $xmhall->hall_name}}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col mx-3">
                                <input class="form-check-input" type="checkbox" name="is_schedule_meeting_chk"
                                       id="is_schedule_meeting_chk" onclick="billingDeal()" @if($xmScMaster->is_schedule_meeting == 1) checked @endif" >
                            ...
                            <div class="col">
                                <div class="form-floating mb-1">
                                    <input type="text" class="form-control" name="meeting_date" id="meeting_date"
                                           value="{{$xmScMaster->meeting_date}}" required readonly
                                           maxlength="15">
                            ...
                            <div class="col">
                                <div class="form-floating mb-1">
                                    <input type="text" class="form-control" name="meeting_time" id="meeting_time"
                                           value="{{$xmScMaster->meeting_time}}" required readonly
                                           maxlength="15">
                            ...
                            <div class="col">
                                <div class="text-center p-2">
                                    <button type="submit" class="btn btn-primary">Update <i class="fa fa-upload" aria-hidden="true"></i></button>
                                    <a href="{{ route('show-ospeioe') }}">Back <i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                                </div>
