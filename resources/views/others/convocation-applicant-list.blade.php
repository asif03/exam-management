...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">14th Convocation</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                  ...
                  <table id="listfcps" class="table table-striped bo" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <button type="button" class="btn btn-outline-primary btn-xs p-2" data-toggle="modal"
                            onclick="showApplicant({{ $fellow->id }})" data-target="#openModal"><i
                              class="fas fa-eye"></i>
                          </button>
                          <a class="btn btn-outline-primary btn-xs p-2"
                            href="{{ route('bcps-convocation-pdf', $fellow->id) }}">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a class="btn btn-outline-primary btn-xs p-2"
                            href="{{ route('bcps-convocation-pdf', $member->id) }}">
                            <i class="fas fa-download"></i>
                          </a>
                        </td>
                      </tr>
        ...
        <div class="modal fade" id="openModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle"
          ...
          <script>
            ...
            function showApplicant(applicantId){
              $.ajax({
                type: "get",
                url: "{{ URL::to('convocationguest') }}/" + applicantId,
                data: "",
