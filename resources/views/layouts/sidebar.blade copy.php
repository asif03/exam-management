  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @php if (in_array(2, $menus)) { @endphp
        <li class="nav-header bg-warning" style="margin-left:-8px; margin-right:-8px;">RTMD Department.</li>
        <li class="nav-item mt-1">
          <a href="{{ route('rtm-dashboard') }}" class="nav-link">
            <i class="nav-icon fas fa-tachometer-alt"></i>
            <p>RTM Dashboard</p>
          </a>
        </li>
        <li class="nav-item">
          <a href="{{ route('workshop-applicant-list') }}" class="nav-link">
