...
<head>
  <title id="titleId">BCPS :: RTMD</title>
  <meta charset="utf-8">
  ...
  <div class="container">
    ...
    <div class="row border">
      <div class="col-12">
        <div class="row p-1">
          <div class="col-md-12 mx-auto text-center">
            <div class="header-title">
              <h4 id="1sth4Id" class="wv-heading-title py-3" style="color: #428BCA;">
                Notice of Protocol Writing Workshop</h4>
            </div>
          </div>
        </div>
        <div class="row mb-2">
        ...
        <div class="row">
          <div class="col-md-12 mx-auto text-center p-4">
            <!--<a class="btn btn-success fw-bold" href="{{ route('rtmd-apply-workshop') }}">Apply Online</a> &nbsp; &nbsp;-->
            <a class="btn btn-success fw-bold" href="{{ route('rtmd-workshop-applicant-list') }}">Registered Applicant
              List</a>
          </div>
        </div>
      </div>
