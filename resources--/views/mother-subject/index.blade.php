      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('mothersubjects.index') }}">Mother Subject Info</a>
            </li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
      ...
      <div class="row">
        <div class="container d-flex flex-column">
          <div class="d-flex flex-row-reverse">
            <a href="{{route('mothersubjects.create')}}" class="btn btn-primary">
              <i class="fa fa-plus" aria-hidden="true"></i> Add Mother Subjects
            </a>
          </div>
          <div class="mt-3">
            <x-alert />
