  ...
  <table width="100%" style="float: left;">
    ...
    <tr>
      <td colspan="2" style="font-size: 14px; text-align: left; padding-top: 5px;">
        ...
        Examinations Department of the college on {{ $schedule->exam_date }} at {{ $schedule->exam_start_time }}.
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td style="font-size: 14px; text-align: left; padding-top: 5px;" colspan="2">
        ...
        <span style="text-align: left; font-weight:bold;">Professor Md. Billal Alom</span> <br>
