...
<body>
  ...
  <main>
    <table width="100%">
      ...
      <tr>
        <td style="font-size: 18px; font-weight: bold; text-align: center;">Date: 10-11 February, 2023</td>
      </tr>
    </table>
    <table width="100%" style="margin-top: 5px; border-spacing: 0px;">
      <tr>
        ...
        <th style="border:#000 1px solid; padding: 2px; font-weight: bold;" align="center">Bank Name</th>
        <th style="border:#000 1px solid; padding: 2px; font-weight: bold;" align="center">Branch Name</th>
        <th style="border:#000 1px solid; padding: 2px; font-weight: bold;" align="center">Receipt No.</th>
      ...
      <tr>
        ...
        <td style="vertical-align: top; border:#000 1px solid; padding: 2px; text-align:left;">{{$fellow->bank_name}}
        </td>
        <td style="vertical-align: top; border:#000 1px solid; padding: 2px; text-align:left;">{{$fellow->bank_branch}}
        </td>
        <td style="vertical-align: top; border:#000 1px solid; padding: 2px; text-align:left;">
          {{$fellow->money_receipt}}
        </td>
